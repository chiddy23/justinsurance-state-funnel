---
title: 'Washington State Insurance Agent Salary: Income Guide'
description: >-
  WA Insurance Agent Salary Income Guide. Practical guide to washington state
  insurance agent salary for Washington agents. Get the rules, timelines, and...
keyword: washington state insurance agent salary
targetKeywords: washington state insurance agent salary
...
imageAlt: >-
  ...
  state insurance agent salary: income guide.
---
...
B&O tax caveat: Washington does have a Business and Occupation (B&O) gross receipts tax, and self-employed or independent producers owe it on gross commissions. This got more expensive recently. Washington used to give insurance producers a preferential 0.484% B&O rate; the legislature repealed that preference effective January 1, 2026 (ESSB 5794), so producer commissions now fall under the Service and Other Activities classification — 1.5% on gross income under $1 million, 1.75% from $1 million to just under $5 million, and 2.1% at $5 million or more. Gross receipts tax is not the same as income tax — it applies to your commissions before expenses — so run the math on your own numbers rather than assuming the old rate. Confirm current rates with the Washington Department of Revenue, and factor B&O into income planning for self-employed or independent agent arrangements. (Producers paid as W-2 employees of an agency do not file B&O on their own wages.)
...
- How does Washington's no state income tax affect agent income? Washington producers pay no state income tax — only federal taxes and, if they are self-employed or independent, the Washington B&O gross receipts tax on commissions. Since January 1, 2026 that means the Service and Other Activities classification: 1.5% of gross commissions for most producers, rising to 1.75% above $1 million and 2.1% above $5 million, after the legislature repealed the old 0.484% insurance-producer preferential rate. The no-income-tax advantage is still real — a $150,000 earner in Washington avoids roughly $13,500-$19,500 in Oregon state income tax and $15,000-$20,000 in California state income tax — but B&O on gross commissions takes back part of it, so build it into your own projections.
...
Washington's combination of no state income tax, technology industry wealth, and diverse market opportunities creates strong career income foundations. Washington does not mandate prelicensing education, so our Washington [exam-prep course](/washington/prelicensing) is optional preparation — but it covers both the national content and the RCW 48 material PSI tests, which is what stands between you and the income described above.
