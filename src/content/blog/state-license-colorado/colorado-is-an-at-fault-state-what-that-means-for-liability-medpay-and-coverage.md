---
title: Colorado Is an At-Fault State — What That Means for Liability, MedPay, and Coverage
description: Colorado is an at-fault state. That single classification shapes every aspect of how auto insurance works for Colorado drivers — who pays after an accid...
keyword: colorado is an atfault state what that means for liability
targetKeywords: colorado is an atfault state what that means for liability
...
imageAlt: Colorado Is an At-Fault State — What That Means for Liability, MedPay, and Coverage
---
...
The 50% bar: A plaintiff whose share of fault is as great as — or greater than — the other party's is completely barred from recovering anything. Under the statute's "not as great as" test (CRS § 13-21-111), a plaintiff who is 50% or more at fault recovers nothing; only a plaintiff whose negligence is less than the defendant's — 49% or below in a two-party crash — can recover at all. The bar is absolute: once a plaintiff's fault reaches 50%, it does not reduce recovery proportionally, it eliminates recovery entirely.

Proportional reduction below 50%: A plaintiff who is found to be less than 50% responsible (49% or below in a two-party crash) may recover, but their award is reduced by their fault percentage. A driver who is 30% at fault for an accident that caused $100,000 in damages recovers $70,000 — the $100,000 reduced by the 30% fault attribution.
...
Selling personal auto coverage in Colorado requires a Property and Casualty or Personal Lines license. Study to the current Pearson VUE content outline until the at-fault, MedPay, and UM/UIM rules covered here are second nature, and verify current fees with the Division and Pearson VUE before you schedule. Once you're licensed, JustInsurance's Colorado [continuing education](/colorado/continuing-education) keeps your casualty lines current.
