---
title: 'Indiana Insurance Code: Core Laws for Licensed Producers'
description: >-
  Indiana Insurance Code Producer Laws. Practical Indiana insurance guide for
  new and experienced agents. Get the rules, timelines, and steps you need.
keyword: indiana insurance code
targetKeywords: indiana insurance code
...
317-232-2389; AgentLicensing@idoi.in.gov; in.gov/idoi
...
Renewal: 2 years; last day birth month; $40 fee; miss it and reinstatement adds a $120 penalty ($160 total to reinstate within 12 months)

CE: 24 hours (3 Ethics); professional org up to 2 hours (IC 27-1-15.7-2.4)

Annuity Best Interest: one-time 4-hour course — or a one-time 1-hour update if you had already completed Indiana's earlier annuity training (760 IAC 1-72-4.5; eff. July 1, 2024)
...
Diminished value: Indiana is 1 of 15 states allowing diminished value claims against at-fault driver's insurer. A diminished value claim is a property damage claim, so it runs on the same 2-year statute of limitations below (IC 34-11-2-4).
...
Indiana's workers' comp premium rates rank among the lowest nationally — 7th-lowest of the 51 jurisdictions in Oregon's 2024 DCBS premium rate ranking study
...
- What is Indiana's diminished value allowance and how does it affect advisory? Indiana is one of approximately 15 states where an at-fault driver can be held liable for the diminished value of the other party's vehicle — the reduction in resale value that occurs when a vehicle has been in an accident even after complete repair. Because a diminished value claim is an auto property damage claim, it is governed by Indiana's 2-year statute of limitations (IC 34-11-2-4) — the same window that applies to the underlying accident claim, not a longer one. Advisory implication: Indiana auto clients who have been hit by at-fault drivers should understand they may have a diminished value claim in addition to property damage repair claims.
