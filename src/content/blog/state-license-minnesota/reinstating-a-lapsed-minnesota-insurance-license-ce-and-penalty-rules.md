---
title: "Reinstating a Lapsed Minnesota Insurance License: CE and Penalty Rules"
description: A lapsed Minnesota insurance producer license can be reinstated — but the process, costs, and conditions depend entirely on how long the license has bee...
keyword: reinstating a lapsed minnesota insurance license ce and
targetKeywords: reinstating a lapsed minnesota insurance license ce and
...
imageAlt: "Reinstating a Lapsed Minnesota Insurance License: CE and Penalty Rules"
---
...
Pay the overdue renewal fee and the penalty: Minn. Stat. §60K.38, Subd. 3 provides that where a renewal fee is received after the due date, "a penalty in the amount of twice the unpaid renewal fee must be paid." Read precisely, that is a penalty *in addition to* the renewal fee — not the renewal fee doubled. The renewal fee is $50 per line of authority under Minn. Stat. §60K.55, so a single-line producer owes the $50 that was never paid plus a $100 penalty. Add the $10 technology surcharge (a separate charge under Minn. Stat. §45.24, and not doubled), and a single-line reinstatement comes to roughly $160 before the NIPR or Sircon transaction fee — proportionally more for multi-line licenses, since both the renewal fee and the penalty scale per line of authority. Confirm the exact total at checkout or with the Department before you budget for it.
...
The most common error is treating the penalty as the entire bill. It is not. The statute imposes a penalty equal to twice the unpaid renewal fee, and the unpaid renewal fee itself is still owed on top of it — so a single-line producer pays $50 for the renewal that was missed plus a $100 penalty, not $100 in total. The $10 technology surcharge and the NIPR transaction fee are not doubled — they are separate charges applied to the transaction regardless of reinstatement status. All in, budget roughly $160 for one line rather than the $100 that the shorthand "double the renewal fee" suggests on its face.
...
Fingerprinting: Complete a new fingerprint-based background check — either electronically at a PSI test center ($63.75) or by mail.
