---
title: 'How to Find KDOI-Approved Kentucky Insurance CE Providers Without Wasting Time or Money'
description: >-
  Kentucky Insurance CE Providers: Find Approved Courses 2025. Practical
  Kentucky insurance guide for new and experienced agents. Get the rules,...
keyword: Kentucky insurance CE providers
targetKeywords: Kentucky insurance CE providers
...
imageAlt: >-
  Kentucky insurance professional reviewing materials related to how to find
  kdoi-approved kentucky insurance ce providers wi.
---
...
The most reliable verification method is direct confirmation from the KDOI. The official website at insurance.ky.gov maintains information about approved CE providers and courses. You can also contact the KDOI Licensing Division at (502) 564-3630 or email DOI.AgentLicensingMail@ky.gov to confirm a specific provider's current approval status.
...
Kentucky requires specific training for three specialty product areas, and each requires provider approval that is specific to that specialty — not just general CE approval. For annuities, the 4-hour Annuity Best Interest training must come from a provider specifically approved for that course under 806 KAR 12:120. For long-term care insurance, 806 KAR 9:025 requires a resident agent selling products qualifying under Kentucky's Long-Term Care Partnership Insurance Program to complete 8 hours of initial LTC training, plus 4 hours of additional LTC training for each biennial CE compliance period after that — both from a provider approved for LTC specialty credit. For NFIP flood insurance, a resident agent holding a property and casualty line of authority must complete the 3-hour flood course under the Flood Insurance Reform Act of 2004, from a provider approved for flood specialty credit.

Note the shape of the LTC requirement in particular. It is the heaviest of the three: 8 hours before your first qualifying sale, then 4 hours in every compliance period that follows. A short introductory LTC course does not satisfy it, and an agent who treats it as a one-and-done is out of compliance the next biennium.
...
- How do I know if a specific Kentucky CE course is KDOI-approved? Ask your CE provider to confirm KDOI approval for the specific course, including the KDOI course approval number. You can also verify directly at insurance.ky.gov or by calling (502) 564-3630. Never assume approval based solely on a provider's general reputation or the fact that they offer courses in other states.
...
- Can I carry over excess CE hours to my next renewal period? Yes, within limits. Under 806 KAR 9:025, a licensee may carry forward up to 12 excess credit hours to the subsequent CE biennium. Carried hours apply as general credit — they do not satisfy the 3-hour ethics requirement or the specialty training (annuity, LTC, flood) that applies in each compliance period. So there is a real banking benefit to finishing early, but cap your expectations at 12 hours and keep the ethics and specialty courses on the current-period list.
- What is JustInsurance's approval status for Kentucky CE? JustInsurance is a KDOI-approved CE provider offering courses across all major lines and specialty product areas including ethics, Annuity Best Interest, LTC, and NFIP flood insurance. All completions are electronically reported through the PSI Services LLC system. Visit justinsuranceco.com/kentucky for the full Kentucky CE course catalog.
JustInsurance's Kentucky-approved CE catalog covers every requirement — ethics, Annuity Best Interest, LTC, and NFIP flood — with courses that are current, accurately reported, and built around what Kentucky producers actually need to know. Enroll at JustInsurance today and make sure every CE hour you complete counts toward your renewal.
