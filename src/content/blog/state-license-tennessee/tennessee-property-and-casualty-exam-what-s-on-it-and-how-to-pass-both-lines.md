---
title: "Tennessee Property and Casualty Exam: What's on It and How to Pass Both Lines"
description: The Tennessee Property and Casualty licensing exams are two separate Pearson VUE exams — Property and Casualty are distinct lines of authority in Tennes...
keyword: tennessee property and casualty exam whats on it and how to
targetKeywords: tennessee property and casualty exam whats on it and how to
...
A note on where JustInsurance fits: we do not sell Tennessee property and casualty prelicensing or a P&C exam-prep product — our prelicensing courses and state practice exams cover the [Life, Health, and Life & Health](/prelicensing) lines only. For the Property and Casualty exams themselves, prepare through a dedicated, state-approved P&C provider that maps to the current Pearson VUE Tennessee content outline. Where JustInsurance can help on the P&C side comes after you pass and are licensed: self-paced, state-approved [continuing education](/property-and-casualty-ce) for the renewal hours Tennessee requires.
