        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              State-approved online insurance prelicensing and CE courses for life and health agents in all 50 states. We&apos;ve helped 15,000+ students get and keep their insurance license.
            </p>
