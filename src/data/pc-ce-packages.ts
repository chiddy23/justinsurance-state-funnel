...
const PC_STATE_REQUIREMENTS: Record<string, StateRequirement> = {
  ...
  IA: { totalHours: 36, ethicsHours: 3, ethicsLabel: "ethics", renewalCycleYears: 3, statuteCitation: "Iowa Admin. Code r. 191-11.3 (Iowa Code §522B.6)" },
  ...
  MA: { totalHours: 45, totalHoursNote: "45 hours is the standard tier; some Massachusetts licensees fall under a 60-hour extended renewal-cycle requirement.", ethicsHours: 3, ethicsLabel: "ethics", renewalCycleYears: 3, statuteCitation: "211 CMR 50.00" },
