...
description: The Minnesota Personal Lines insurance licensing exam covers a focused subset of the full P&C curriculum — the property and casualty products that serve...
keyword: minnesota personal lines exam whats on it and how to pass
targetKeywords: minnesota personal lines exam whats on it and how to pass
...
imageAlt: "Minnesota Personal Lines Exam: What's on It and How to Pass"
---
...
Exam administrator: PSI Services LLC Exam format: Multiple choice, four options per question, one correct answer Scored questions: 100 — 75 in the general section plus 25 in the Minnesota state law section, per PSI's published Minnesota Personal Lines content outline Unscored items: PSI may add 5 to 15 experimental questions that do not count toward your score but do count against your exam time Time allowed: 120 minutes Passing score: 70% Results: Immediate — displayed on screen at conclusion, with a score report emailed afterward Retakes: No limit; 24-hour wait; $45 fee per attempt Exam validity: 3 years from date of passing
...
Free look — a life insurance right, not a homeowners one: Minnesota's 10-day free look applies to life insurance policies. There is no statutory free-look or full-refund window on a Minnesota homeowners policy, and candidates who assume one exists lose points on this question. Personal lines policyholders are protected instead by the cancellation and nonrenewal notice requirements covered in Section 6, and by the insurer's obligation to return unearned premium when a policy is cancelled.
...
The no-fault claim process: After an accident, the injured party files a PIP claim with their own insurer first — regardless of fault. PIP pays medical expenses and non-medical expenses (lost wages at 85% of gross income, capped at $500/week; replacement services; funeral expenses up to $2,000) up to the $40,000 limit. Six-month notice provision applies — under Minn. Stat. §65B.55, subd. 1 a policy may require the insured to notify the insurer of the accident and a possible claim within a period of not less than six months. It is a notice rule, not an automatic filing bar: late notice defeats benefits only if the insurer proves it was actually prejudiced by the delay, and then only to the extent of that prejudice.
...
The injury caused disability for 60 days or more — an inability to engage in substantially all of the injured person's usual and customary daily activities (Minn. Stat. §65B.51, subd. 3). This trigger is the one candidates most often omit: it turns on duration rather than on a dollar figure or a permanent finding, so a soft-tissue injury that keeps someone off their normal routine for two months can meet the threshold even when treatment costs stayed under $4,000.
...
Earning Personal Lines authority in Minnesota requires a state-approved Personal Lines pre-licensing course. Study to the current PSI content outline and drill every topic in this guide with full-length practice exams. Once you are licensed, JustInsurance offers Minnesota property and casualty [continuing education](/minnesota/continuing-education) to keep your authority current at every renewal.
