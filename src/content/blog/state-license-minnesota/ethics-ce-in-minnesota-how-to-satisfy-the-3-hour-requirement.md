---
title: "Ethics CE in Minnesota: How to Satisfy the 3-Hour Requirement"
description: Minnesota requires every licensed insurance producer to complete 3 hours of ethics continuing education as part of each biennial 24-hour CE obligation.
keyword: ethics ce in minnesota how to satisfy the 3hour requirement
targetKeywords: ethics ce in minnesota how to satisfy the 3hour requirement
...
Minnesota's CE requirement has three components: 24 total hours, 3 ethics hours, and 12 non-company-sponsored hours. Ethics hours interact with the other two components in important ways.
...
Ethics courses can simultaneously satisfy the non-company-sponsored requirement. An ethics course from an independent CE provider — not affiliated with any insurance carrier — satisfies both the ethics requirement and the non-company-sponsored requirement for those hours, regardless of whether the course is self-paced online or delivered another way. Carrier-sponsored ethics training, if approved as ethics CE, satisfies the ethics requirement but not the non-company-sponsored requirement.

The maximum ethics overlap scenario: A producer who completes a 3-hour ethics course from an independent, self-paced online provider satisfies both of the most restrictive components simultaneously: ethics (3/3) and non-company-sponsored (3/12). The remaining 21 CE hours can then include up to 12 hours of company-sponsored training and 9 additional hours of self-paced online non-company-sponsored training — completing the full 24-hour requirement with maximum flexibility and no live attendance required.
...
Use a self-paced 3-hour ethics course from an independent provider to satisfy ethics and non-company-sponsored simultaneously. As described above, this single enrollment satisfies two of the three CE components at once, with no scheduling constraints. For a producer who wants to minimize the complexity of their CE calendar, starting with a 3-hour ethics course from an independent provider is the highest-efficiency first step.

For producers who sell LTC: If you are subject to the 4-hour biennial LTC refresher requirement, check whether the LTC course carries any ethics credit. Some LTC-specific courses include ethics content that is approved for ethics CE credit. If so, the LTC course may reduce the standalone ethics CE you need to complete — but verify the specific ethics credit designation in the Department's course system before relying on this.
...
Can I satisfy the full 3-hour ethics requirement with a self-paced online ethics course?

Yes. A self-paced online ethics course can satisfy the ethics requirement as long as it is approved by the Minnesota Department of Commerce as ethics CE. Minnesota's CE law does not require live or in-person instruction for any portion of the 24-hour requirement, including ethics hours. A self-paced online 3-hour ethics course from an approved independent provider satisfies the ethics requirement, counts toward the 24-hour total, and — if the provider is independent rather than carrier-affiliated — also counts toward the 12-hour non-company-sponsored minimum, all in a single enrollment.

Minnesota's 3-hour ethics CE requirement is a well-defined obligation with clear qualification standards, a straightforward verification process, and significant efficiency when planned to satisfy multiple CE components simultaneously. Producers who verify ethics credit before enrolling, front-load ethics CE in their renewal period planning, and use a self-paced course from an independent provider to maximize component overlap will find the requirement easily manageable within their broader 24-hour CE obligation.

Visit JustInsurance to enroll today and complete your Minnesota ethics CE with a state-approved provider — verified ethics credit typically reported to the Department the same day you finish.
