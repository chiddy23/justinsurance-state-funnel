---
title: "Tennessee Auto Insurance: What the 25/50/25 Minimums Mean and How the Fault System Works"
description: Every Tennessee driver is required by law to carry auto insurance meeting minimum coverage standards established under Tennessee's financial responsibil...
keyword: tennessee auto insurance what the 255025 minimums mean and
targetKeywords: tennessee auto insurance what the 255025 minimums mean and
...
imageAlt: "Tennessee Auto Insurance: What the 25/50/25 Minimums Mean and How the Fault System Works"
---
...
Proving an unidentified (hit-and-run) vehicle: Under Tenn. Code Ann. § 56-7-1201(e), a UM claim involving an unknown vehicle requires one of two things — either actual physical contact between the unidentified vehicle and the insured or the insured's property, OR the existence of the unknown vehicle established by clear and convincing evidence other than the testimony of the insured vehicle's own occupants. In either case, the insured must have reported the accident to law enforcement within a reasonable time and must not have been negligent in failing to identify the other vehicle. This means a phantom-vehicle claim — an unidentified driver who runs the insured off the road without ever making contact — can still qualify if the insured establishes the unknown vehicle's existence by clear and convincing evidence, so physical contact is one pathway to coverage rather than an absolute prerequisite.
...
UIM coverage pays the gap between what the at-fault driver's liability insurer paid and the insured's actual proven damages — up to the UIM policy limit, which Tennessee law reduces (offsets) by the amount the at-fault driver's insurer already paid. Tennessee is a reduction state, not an add-on state: the UIM limit is the ceiling on the insured's total recovery, not an amount stacked on top of the at-fault driver's payment.
...
The UIM gap scenario: The insured sustains $150,000 in bodily injury damages. The at-fault driver carries minimum 25/50 liability — the insurer pays $25,000. Under Tenn. Code Ann. § 56-7-1201(d), the UIM carrier reduces its limit by the amount paid by or on behalf of the at-fault driver. If the insured's UIM limit is $100,000, that limit is offset by the $25,000 the at-fault driver's policy pays, leaving $75,000 of UIM benefit available. The insured receives $25,000 from the at-fault driver's policy plus $75,000 from UIM — totaling $100,000, leaving $50,000 of the $150,000 in damages uncompensated. This offset is why a Tennessee UIM limit set only at the at-fault driver's liability level provides no net UIM benefit at all.
...
Tennessee has one of the highest uninsured-motorist rates in the country. The Insurance Research Council estimates that roughly one in five Tennessee drivers — about 21% as of 2023, and as high as 23.7% in 2019 — carries no insurance at all, well above the national average of about 15%. Many more carry only minimum 25/50/25 limits. The client who is seriously injured by one of these drivers recovers only what their own UM/UIM coverage provides above the at-fault driver's inadequate payment.
...
The 25/50/25 structure, the at-fault and 50% bar rules, and the UM/UIM offset mechanics in this guide are tested on Tennessee's Property, Casualty, and Personal Lines exams — a separate line of authority from Life and Accident & Health. Use this guide as a study reference for that auto insurance material, and confirm any Property and Casualty course you choose covers the current Tennessee statutes above. JustInsurance's Tennessee exam prep is built to the current Pearson VUE content outlines for the Life, Accident & Health, and combined Life & Health lines — visit JustInsurance to enroll in that preparation and start your Tennessee licensing path.
