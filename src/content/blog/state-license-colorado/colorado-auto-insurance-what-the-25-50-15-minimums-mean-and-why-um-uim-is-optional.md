---
title: "Colorado Auto Insurance: What the 25/50/15 Minimums Mean and Why UM/UIM Is Optional"
description: Colorado requires every driver to carry auto liability insurance meeting minimum limits of 25/50/15 under CRS § 42-7-103.
keyword: colorado auto insurance what the 255015 minimums mean and
targetKeywords: colorado auto insurance what the 255015 minimums mean and
...
imageAlt: "Colorado Auto Insurance: What the 25/50/15 Minimums Mean and Why UM/UIM Is Optional"
---
...
The statute's operative words are that contributory negligence does not bar recovery "if such negligence was not as great as the negligence of the person against whom recovery is sought." Under this rule:

A plaintiff (injured party) whose share of fault is less than the at-fault driver's may recover, but their recovery is reduced proportionally by their own fault percentage. A plaintiff who is 30% at fault recovers 70% of their proven damages; a plaintiff who is 49% at fault recovers 51%.

A plaintiff who is 50% or more at fault is completely barred from recovery. Fifty-fifty is not a half recovery. At exactly 50% the plaintiff's negligence is as great as the defendant's, the statute's condition fails, and CRS § 13-21-111(3) directs the court to enter judgment for the defendant. The bar closes at 50%, not at 51% — this is the single detail about Colorado's rule that gets stated backwards most often.

Why this matters for auto insurance producers: The 50% bar rule affects how UM/UIM coverage is valued in Colorado. A client who is even arguably half responsible for a collision walks away from the third-party claim with nothing, however serious their injuries. And because UM/UIM responds only to damages the insured is "legally entitled to recover" from the uninsured or underinsured driver under CRS § 10-4-609, the same 50% bar reaches the UM/UIM claim — a client barred from suing the other driver is equally barred from collecting UM/UIM. What still pays in that scenario is first-party coverage that ignores fault: MedPay, collision, and the client's own health plan. That is the coverage conversation the 50% bar should drive.
...
Underinsured Motorist (UIM) Coverage pays when the at-fault driver has insurance but their limits are insufficient to cover the insured's proven damages. Colorado bars the setoff that many states permit. Under CRS § 10-4-609(1)(c), "the amount of the coverage available pursuant to this section shall not be reduced by a setoff from any other coverage, including, but not limited to, legal liability insurance, medical payments coverage, health insurance, or other uninsured or underinsured motor vehicle insurance." Colorado UIM sits on top of the at-fault driver's liability limits instead of absorbing them — the rule for every Colorado policy issued or renewed since January 1, 2008.

Example of how Colorado UIM stacks: An insured has $100,000 UIM coverage. The at-fault driver has $25,000 bodily injury liability, which is exhausted by the claim. The insured's proven damages total $110,000. The at-fault driver's insurer pays $25,000, and the UIM insurer pays the remaining $85,000 out of its own $100,000 limit. Total received: $110,000. The $25,000 the liability carrier paid is not subtracted from the $100,000 UIM limit. The practical ceiling on the recovery is the insured's actual proven damages — not the UIM limit reduced by whatever the other driver's policy happened to pay.

Minimum UM/UIM limits: The minimum UM/UIM limits a policyholder can purchase in Colorado are $25,000 per person and $50,000 per accident — matching the state's minimum bodily injury liability limits. The policyholder may purchase higher UM/UIM limits, but CRS § 10-4-609(2) obligates the insurer to offer UM/UIM only up to the insured's own bodily injury liability limits, and carriers write to that ceiling. A driver with $100,000/$300,000 bodily injury liability can purchase UM/UIM up to $100,000/$300,000.
...
In practice, no — but it is worth knowing exactly what the statute says. CRS § 10-4-609(2) requires the insurer to offer UM/UIM "in an amount equal to the insured's bodily injury liability limits, but in no event shall the insurer be required to offer limits higher than the insured's bodily injury liability limits." The statute caps what a carrier is obligated to offer rather than expressly outlawing a higher limit, and carriers write to that ceiling — so the bodily injury liability limit functions as the practical maximum on UM/UIM. A driver with $25,000/$50,000 bodily injury liability will be offered up to $25,000/$50,000 UM/UIM; a driver with $250,000/$500,000 will be offered up to $250,000/$500,000. UM/UIM may also be carried at a limit lower than liability. The producer takeaway: a client who wants more UM/UIM than their current bodily injury limit generally has to raise the bodily injury limit first — not because the two coverages must move in lockstep, but because the liability limit sets the ceiling the carrier will offer.
...
Yes — provided your proven damages exceed what the liability insurer paid. This is the point on which Colorado departs from setoff states. Because CRS § 10-4-609(1)(c) prohibits any setoff, matching limits do not cancel each other out. If the at-fault driver carries $100,000 in bodily injury liability and pays it in full, and you carry $100,000 in UIM, your UIM insurer remains responsible for damages above that first $100,000 up to its own limit — up to $200,000 of total recovery on $200,000 of proven damages. The trigger for UIM is that your damages exceed what the at-fault driver's insurer paid, not that the at-fault driver's limits are lower than yours. Producers who learned Colorado's pre-2008 rule, or who trained in a setoff state, get this backwards and undersell UIM limits as a result.
...
To sell personal auto in Colorado you'll need a Property and Casualty or Personal Lines license — study to the current Pearson VUE content outline until the auto provisions in this post are automatic, and confirm the latest fees with the Division and Pearson VUE before you register. Once you're licensed, JustInsurance's Colorado [continuing education](/colorado/continuing-education) keeps your auto and casualty lines current through every renewal.
