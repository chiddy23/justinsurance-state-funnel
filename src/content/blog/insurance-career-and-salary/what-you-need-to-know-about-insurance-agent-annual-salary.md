...
If you’re ready to explore your options, the first move is the same for everyone: get licensed in your state, then keep that license current. The right knowledge can put you on track to a fulfilling, profitable career in insurance. Explore our self-paced [insurance prelicensing courses](/prelicensing) and [continuing education](/continuing-education) courses to get started.
