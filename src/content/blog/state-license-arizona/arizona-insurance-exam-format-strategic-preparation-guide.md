---
title: 'Arizona Insurance Exam Format: Strategic Preparation Guide'
description: >-
  Arizona Insurance Exam Format Strategy Guide. Practical Arizona insurance
  guide for new and experienced agents. Get the rules, timelines, and steps
  you...
keyword: arizona insurance exam format
targetKeywords: arizona insurance exam format
...
All Arizona major-line insurance exams share common characteristics:

Computer-based. At PSI testing centers or via PSI Bridge remote proctoring.

Multiple choice only. No essay, fill-in-the-blank, or other format.
...
100-question exams (2 hours): ~72 seconds per question

150-question exams (2.5 hours): ~60 seconds per question
...
## The Four-Attempt Annual Limit — Strategic Reality

Arizona's 4-attempt limit under A.R.S. § 20-284(H) fundamentally changes exam risk calculus:

What it means: Four attempts per line per year. After four failures, mandatory 1-year wait from the last attempt before retesting. Failing a combined exam counts as failing each individual line covered.
...
Plus reapplication considerations
...
Life is generally considered easier — pass it first, build confidence, then focus on A&H

A&H consistently reported as harder than Life — benefits from focused preparation

Recommendation for most candidates: Unless you have strong insurance background in both areas, take Life and A&H separately. The A&H exam is harder, and splitting preparation allows focused attention on health/disability content that can overwhelm combined study.

For Property and Casualty candidates:

Combined P&C (Series 13-34, 150 questions, 2.5 hours):
...
Read every question completely before looking at answers. Arizona exam questions sometimes contain important modifier words that determine the correct answer direction.

Watch for qualifier words:

"EXCEPT" — the question asks for the FALSE or non-applicable answer

"MOST LIKELY" — requires judgment about probability
...
First pass: Answer all confident questions immediately

Flag uncertain questions without answering
...
What does A.R.S. Title 20 specifically say?
...
Practice Arizona-specific unfair trade practices

Review replacement regulations
...
Identify which product areas scored lowest

Increase practice question volume in weak areas
