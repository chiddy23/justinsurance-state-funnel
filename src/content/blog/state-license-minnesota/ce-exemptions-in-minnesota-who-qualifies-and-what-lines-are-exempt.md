---
title: "CE Exemptions in Minnesota: Who Qualifies and What Lines Are Exempt"
description: Minnesota's continuing education requirement applies broadly — but not universally.
keyword: ce exemptions in minnesota who qualifies and what lines are
targetKeywords: ce exemptions in minnesota who qualifies and what lines are
...
Individuals licensed for less than 6 months prior to the first renewal date are exempt for the first renewal period.
...
Individuals holding a limited-lines license that does not require an exam are exempt from Minnesota's CE requirements.
...
Non-resident producers (except for the LTC requirement) are exempt from Minnesota's CE requirements, provided they satisfy their home state's CE requirements.

Nonresident producers whose home state has a reciprocal agreement with Minnesota satisfy Minnesota's CE through home state compliance. Nonresident license holders can rely on their own state's CE compliance, since Minnesota recognizes that being current on the CE requirements of your own state is sufficient.
...
One important feature of Minnesota's CE system that is worth understanding alongside the exemption framework is the absence of line-of-authority restrictions on CE content. Minnesota does not require that insurance producers complete only modules relating to the lines of authority that they hold. For example, a producer who holds a Life line of authority can complete and use a continuing education course pertaining to property and casualty.

Minnesota also explicitly states that — aside from areas like flood insurance, the MNsure marketplace, and long-term care — there aren't requirements for licensees to keep CE confined to their lines of authority.
