...
export const STATES: Record<string, StateData> = {
  alabama: {
    ...
    citations: {
      ...
      statutesUrl: "http://alisondb.legislature.state.al.us/alison/codeofalabama/1975/coatoc.htm",
  ...
  connecticut: {
    ...
    citations: {
      ...
      statutesUrl: "https://www.cga.ct.gov/current/pub/title_38a.htm",
  ...
  "north-carolina": {
    ...
    citations: {
      ...
      adminCodeRef: "Title 11 - Insurance",
      adminCodeUrl: "http://reports.oah.state.nc.us/ncac.asp?folderName=%5CTitle+11+-+Insurance",
  ...
  oklahoma: {
    ...
    citations: {
      ...
      statutesUrl: "http://www.oscn.net/applications/oscn/index.asp?level=1&ftdb=STOKST36",
