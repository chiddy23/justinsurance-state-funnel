---
title: "Colorado Workers' Compensation: Pinnacol Assurance, the Private Market, and Employer Obligations"
description: Colorado workers' compensation law is among the most employer-inclusive in the country.
keyword: colorado workers compensation pinnacol assurance the
targetKeywords: colorado workers compensation pinnacol assurance the
...
imageAlt: "Colorado Workers' Compensation: Pinnacol Assurance, the Private Market, and Employer Obligations"
---
...
Colorado takes employer non-compliance seriously, and the consequences are layered — a daily fine, an extra 25% owed on any claim that occurs during the gap, and the authority to shut the business down until coverage is in force:

Daily fine: Under C.R.S. § 8-43-409, the Director may fine an employer in default up to $250 per day for an initial violation, and not less than $250 nor more than $500 per day for a second or subsequent violation. The fine accrues for every day the employer failed to carry the required coverage — it is assessed per day of default, not per day per employee, so it does not multiply by headcount. A first-time employer who goes uncovered for 30 days is looking at a statutory maximum of roughly $7,500. That is real money for a small business, and a lapse that runs for months rather than weeks can climb into six figures at the repeat-violation rate.

The 25% payment on claims during non-coverage: If an employee is injured during the period when the employer had no workers' comp coverage, the employer is directly liable for all benefits owed to the injured worker — and under C.R.S. § 8-43-408, the uninsured employer must also pay an amount equal to 25% of the compensation and benefits the employee is entitled to into the Colorado Uninsured Employer Fund. An employer who was uninsured at the time of a $100,000 injury claim is out roughly $125,000, with no insurer to share the burden.

Business shutdown: The Director may order an employer in default to cease and desist from business operations for as long as the default continues, and the Attorney General may go to court for an injunction barring the employer from operating until the required insurance is procured.

Fraud exposure: Willfully making a false statement material to a workers' compensation claim is a class 6 felony under C.R.S. § 8-43-402, and an employer who deliberately misreports payroll or misclassifies employees to reduce premium is exposed to criminal fraud prosecution on top of the civil penalties above and the premium recovered at audit.
...
The independent contractor misclassification risk: Employers who routinely pay workers as independent contractors should understand that Colorado's classification test is fact-specific and that misclassification produces uncovered workers' comp claims — and, where the misclassification was deliberate, fraud exposure. If a worker classified as an independent contractor is injured and determined by the CDWC to be an employee, the employer faces the full penalty structure — the daily fine under C.R.S. § 8-43-409, the 25% payment into the Uninsured Employer Fund, and direct liability for every dollar of benefits on the claim.
...
Serving Colorado employers on workers' compensation takes a Casualty (or Property and Casualty) license. Study to the current Pearson VUE content outline until the coverage-threshold, Pinnacol, and benefit rules covered here are second nature, and verify current fees with the Division and Pearson VUE before you schedule. Once you're licensed, JustInsurance's Colorado [continuing education](/colorado/continuing-education) keeps your casualty lines current.
