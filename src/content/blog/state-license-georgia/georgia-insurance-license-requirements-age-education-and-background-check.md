---
title: 'Georgia Insurance License Requirements: Age, Education, and Background Check'
description: >-
  Georgia Insurance License: Age, Education & Background. Requirements, fees,
  study hours, exam logistics, and compliance steps every licensed agent needs.
keyword: georgia insurance license requirements
targetKeywords: georgia insurance license requirements
...
For a resident license, you must:

- Be a resident of Georgia, or

- Maintain your principal place of business in Georgia

Non-Georgia residents who want to conduct insurance business with Georgia clients typically apply for a non-resident Georgia license once they're licensed in their home state.
...
- Life-only license: 8 hours of approved life insurance prelicense education

- Accident and sickness only: 8 hours of approved health insurance prelicense education

- Property and casualty license: 16 hours of approved P&C prelicense education

- Personal lines license: 8 hours of approved personal lines prelicense education

Prelicense education must be completed through an OCI-approved provider, and you must receive a completion certificate before you can register for the state exam.
...
- Georgia Bureau of Investigation (GBI) — state criminal history

- FBI — federal criminal history

Results are returned directly to OCI. You don't receive a copy.

## What OCI Checks in the Background

OCI reviews criminal history along with:

- Prior license denials, suspensions, or revocations in any state

- Regulatory actions from other state departments

- Disciplinary history in professional or financial fields

- Your application disclosures

- Civil judgments and bankruptcies (as applicable)

## What Can Cause Application Issues

Not every criminal record disqualifies you. OCI evaluates the nature of the offense, how long ago it occurred, evidence of rehabilitation, and its relevance to insurance work.

Issues most likely to cause problems:

- Financial crimes — fraud, embezzlement, forgery, theft

- Crimes involving dishonesty — misrepresentation, perjury, identity theft

- Prior insurance regulatory actions — license denial, revocation, suspension

- Pending criminal charges — typically delay approval until resolution

- Felony convictions — especially recent ones

## What Typically Doesn't Disqualify
...
- Old, isolated misdemeanors unrelated to financial or dishonest conduct

- Bankruptcies (by themselves)

OCI weighs context. A 15-year-old minor offense is very different from recent financial crimes.

## Application Disclosures

Your license application requires you to answer specific questions about your history — criminal issues, regulatory actions, license denials, bankruptcy, civil judgments, and more.

Answer honestly. OCI cross-references your answers against background check results. Discovering an omission is almost always worse than disclosing the original issue.

Err on the side of disclosure. If you're unsure whether something needs to be disclosed, disclose it. Providing context is better than appearing to hide information.

Provide documentation where relevant. Court records, certificates of rehabilitation, explanation letters for past issues — all can support your application.
...
Full disclosure with documentation. Sometimes the best approach is simply to apply with complete transparency and supporting documentation. OCI often approves applicants with past issues who demonstrate rehabilitation.
...
4. Can I start my prelicense course before completing the background check? Yes. You can start prelicense education anytime. Fingerprinting is typically done during or after your studies.

5. What happens if my application is denied? You'll receive a written explanation. You have the right to request a hearing and appeal the decision through Georgia's administrative process.

## Approach Your Georgia License Application with Confidence
