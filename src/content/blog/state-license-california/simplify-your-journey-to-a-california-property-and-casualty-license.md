...
Getting your property and casualty license is largely a self-directed path now that AB 943 leaves only the 12-hour Code and Ethics course as required prelicensing education. For the P&C exam itself, build your study plan around the current PSI content outline so you cover every property, casualty, and California-law topic the state tests — that focused preparation is where most candidates do the real work.
