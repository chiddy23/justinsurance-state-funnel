...
export const STATES: Record<string, StateData> = {
  alabama: {
    ...
    examInfo: {
      ...
      examProviderUrl: "https://training.ua.edu/insurance-testing/",
    ...
    specialNotices: [
      ...
      },
      {
        ...
        link: { href: "https://training.ua.edu/insurance-testing/", text: "University of Alabama insurance testing", external: true },
      },
      {
        kind: "tip",
    ...
    citations: {
      ...
      statutesUrl: "https://alison.legislature.state.al.us/",
  ...
  alaska: {
    ...
    agentLicensingUrl: "https://www.commerce.alaska.gov/web/ins/",
    licenseApplicationPortal: "https://nipr.com/licensing-center/apply",
    licenseDuration: "2 years",
    minAge: 18,
    ...
    ce: {
      ...
      renewalPeriod: "2 years",
      ethicsHours: 3,
      requirementsUrl: "https://www.commerce.alaska.gov/web/ins/",
      packagePrice: "$75",
      ethicsCoursePrice: "$10",
      individualCoursePrice: "$10",
      completionTime: "just a few hours",
    ...
    specialNotices: [
      ...
      },
      {
        ...
        link: { href: "https://www.commerce.alaska.gov/web/ins/", text: "Alaska Division of Insurance producers", external: true },
      },
    ],
  ...
  california: {
    ...
    stateSpecificFAQ: {
      ...
      answer: "California requires all new insurance license applicants to complete a 12-hour Code and Ethics (C&E) prelicensing course. As of January 1, 2026, California Assembly Bill 943 eliminated the previous line-specific product prelicensing hour requirement — the 12-hour C&E course is now the only mandatory prelicensing education for Life, Accident & Health, and P&C applicants. The course covers the California Insurance Code, ethics standards, and agent responsibilities. JustInsurance's California prelicensing courses cover the Life, Health, and Life & Health lines of authority only, preparing you for the 12-hour C&E requirement and the Life & Health licensing exam; JustInsurance does not sell property and casualty prelicensing or a P&C exam prep product, so P&C applicants should complete their prelicensing through a California-approved property and casualty provider.",
    },
  },
  ...
  illinois: {
    ...
    citations: {
      ...
      statutesUrl: "https://www.ilga.gov/",
  ...
  mississippi: {
    ...
    citations: {
      ...
      statutesUrl: "https://www.sos.ms.gov/",
