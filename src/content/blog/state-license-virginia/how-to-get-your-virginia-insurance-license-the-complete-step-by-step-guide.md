...
How to register: Go to prometric.com/virginia/insurance or call (866) 891-6396. You can also register by fax or mail, though online scheduling is the fastest method. The exam fee must be paid at the time of registration by MasterCard, Visa, money order, company check, or cashier's check. Personal checks are not accepted.

Exam fee: $35 per exam, regardless of line.

What exam to take: Virginia licenses producers by line of authority. The major exam series are:

The passing score for all major exams is 70%.

No prelicensing course required — Virginia does not mandate prelicensing education before any exam except Title insurance (which requires a 16-hour course). However, the exam is genuinely challenging, and nearly all successful candidates complete a prep course or study program before sitting.
...
How to schedule: Go to fieldprintvirginia.com and use the Fieldprint Code FPVABOIProducer. This code ensures results are routed to the Bureau of Insurance. Do not use an alternative Fieldprint code.

Cost: $34.95 (includes Virginia State Police and FBI fees).
...
Most candidates complete the entire process — passing the Prometric exam, completing fingerprinting, and receiving license approval — in two to four weeks. The exam itself can be scheduled as soon as you feel prepared, sometimes within days of deciding to get licensed. The main variables are how long you spend studying before the exam and how quickly the Bureau of Insurance processes your application (typically 15 business days from submission). The fastest path is to schedule your fingerprinting appointment at Fieldprint at the same time you schedule your Prometric exam, so both steps happen around the same time and you can submit your application immediately after passing.
...
If you fail a Virginia insurance exam, you must wait at least 24 hours before rescheduling for a retake. This 24-hour window is a scheduling restriction — you can call Prometric or schedule online the next day. However, after failing the same exam three times, Virginia law imposes a mandatory 30-calendar-day waiting period before you can attempt that exam again. There is no lifetime limit on attempts in Virginia. Each retake costs $35. Your diagnostic score report from each failed attempt shows your performance by section — use it to target your study for the retake rather than studying the entire content from scratch.

Can I submit my fingerprints before I take the exam?

Yes, and this is often the most efficient approach. Virginia allows you to complete fingerprinting through Fieldprint before or after passing the Prometric exam — the two steps are independent. The only sequencing constraint is that your fingerprints cannot be more than 90 days old when you submit your application, and you must submit your application within 90 days of completing fingerprinting. If you schedule fingerprinting roughly the same week as your exam, you will be positioned to submit your application immediately after passing. Just be sure to use Fieldprint Code FPVABOIProducer — not any other Fieldprint code — to ensure results are routed to the Virginia Bureau of Insurance.

What regulator issues Virginia insurance licenses, and how is Virginia different from other states?
