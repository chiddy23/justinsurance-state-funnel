---
title: 'How to Find Wisconsin OCI-Approved Insurance CE Providers'
description: >-
  Wisconsin OCI-Approved CE Providers Guide. Practical guide to wisconsin
  insurance CE providers for Wisconsin agents. Get the rules, timelines, and...
keyword: wisconsin insurance CE providers
targetKeywords: wisconsin insurance CE providers
...
imageAlt: >-
  Wisconsin insurance professional reviewing materials related to how to find
...
OCI approval status for the specific course.

Credit type: Ethics, Life, Health, Property, Casualty, Personal Lines, Annuity, LTC, NFIP Flood, Life Settlement.
...
## Wisconsin CE Planning Example

Full-market producer (Life + A&H + P&C) — 24 hours needed:

3-hr Ethics ✓

4-hr Annuity Best Interest (one-time) ✓

8-hr LTC initial (one-time; includes 2 hrs WI Medicaid) ✓ OR 4-hr LTC refresher (includes 1 hr WI Medicaid) ✓
...
Complete 24 CE hours before renewal deadline

Verify CE transcript at oci.wi.gov

Submit renewal through NIPR

Pay $35 renewal fee

Confirm renewal confirmation from OCI

No grace period — submit before the last day of birth month.
