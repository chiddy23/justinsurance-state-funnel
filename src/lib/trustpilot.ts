...
const TRUSTPILOT_REVIEWS_RAW: TrustpilotReview[] = [
  ...
  { name: "Kelly G.", initials: "KG", stars: 5, date: "2026-06-16", excludeFromDisplay: true, excludeReason: "Unnamed-competitor comparative-superiority claim ('I had used a different training program previously and there's no comparison to JustInsurance'). mentionsCompetitor() can't catch it (rival unnamed), but republishing it as our marketing adopts an unsubstantiable comparative claim (FTC/Lanham) — same treatment as the analogous excluded YouTube record. Record kept for provenance; words unedited.", text: "Exceptional service, highly detailed and thorough training. I had used a different training program previously and there’s no comparison to JustInsurance. If you’re studying for the insurance exam look no further." },
