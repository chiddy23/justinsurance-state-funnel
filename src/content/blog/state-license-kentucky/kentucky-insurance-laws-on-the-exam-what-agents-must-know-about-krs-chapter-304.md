...
- Is Kentucky's workers' compensation coverage requirement tested on the Property & Casualty exam? Yes. Know the 1-employee coverage threshold, the Class D felony penalty for non-compliance, that NCCI is the rating bureau, and that the DWC (not the KDOI) administers claims.
JustInsurance's Kentucky prelicensing course covers all KRS Chapter 304 content tested on the KDOI exam. Prepare thoroughly and pass with confidence. Enroll at justinsuranceco.com.
