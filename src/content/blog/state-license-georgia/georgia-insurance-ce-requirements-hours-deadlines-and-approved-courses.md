---
title: 'Georgia Insurance CE Requirements: Hours, Deadlines, and Approved Courses'
description: >-
  Georgia Insurance CE Requirements: Hours & Deadlines. Requirements, fees,
  study hours, exam logistics, and compliance steps every licensed agent needs.
keyword: georgia insurance CE requirements
targetKeywords: georgia insurance CE requirements
...
This applies to Life, Accident, and Sickness licensees, Property and Casualty licensees, and most combination license holders. Some limited lines licenses have reduced CE hours.

## CE by License Type

Life, Accident, and Sickness: 24 hours every 2 years, including 3 hours of Ethics.

Property and Casualty: 24 hours every 2 years, including 3 hours of Ethics.

Combined license holders (Life/Health + P&C): Generally 24 hours covers both, though specific content areas must be addressed.

Personal Lines only: 24 hours every 2 years with the Ethics requirement.

Limited Lines (travel, credit, etc.): Reduced CE requirements apply. Confirm with OCI for your specific limited line.
...
- Must be completed through an OCI-approved ethics course
...
Only courses approved by OCI count toward your CE requirement. Approved courses cover topics like:
...
- Georgia-specific law and regulation
...
Before enrolling in any CE course, confirm it's on OCI's approved provider and course lists. Non-approved courses don't count regardless of quality or subject matter.

## Finding Approved Courses

Several ways to verify approval:

- Check OCI's online producer portal

- Use Sircon (sircon.com) to search approved providers and courses

- Look for OCI course approval numbers on course listings

- Ask the provider directly to confirm approval

Reputable CE providers always list their OCI approval clearly. Providers that can't confirm approval status aren't worth using.
...
- Your license enters lapsed status if renewal is rejected

- You cannot conduct insurance business until the license is reinstated

- Late fees apply during the grace period

- Reinstatement fees apply if you're beyond the grace period

- Extended non-compliance may require reapplication from scratch (potentially including retaking the exam)
...
Complete CE throughout the cycle, not just at the end. Spreading hours across the 2-year period builds the habit and prevents last-minute panic.

Check your CE status quarterly. Log into OCI's system or your Sircon account to confirm hours are being reported correctly.
...
Don't wait until the final month. Even with automated reporting, there's a lag between completion and OCI's record update. Build in a 30-day buffer before your deadline.

Use reputable, OCI-approved providers. Cheap or shady providers create reporting nightmares.

## Specialty CE for Certain Products

If you sell specific specialty products, additional training may apply:

Long-term care. Georgia typically requires specific LTC training for agents selling long-term care insurance.

Annuities. Georgia has annuity suitability training requirements for agents selling annuity products.

Medicare. While not a formal CE requirement from OCI, most carriers require Medicare agents to complete AHIP certification or similar training annually.
...
4. Does the Ethics requirement change every cycle? The 3-hour Ethics requirement applies to every 2-year cycle. You must complete it each renewal period.

5. What if I hold licenses in multiple states? Georgia CE satisfies Georgia requirements. Other states have their own CE rules — though many states have home-state reciprocity that allows Georgia CE to satisfy non-resident obligations. Verify with each state.
