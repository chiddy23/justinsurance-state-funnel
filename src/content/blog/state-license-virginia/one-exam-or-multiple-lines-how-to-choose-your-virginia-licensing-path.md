---
title: One Exam or Multiple Lines? How to Choose Your Virginia Licensing Path
description: >-
...
keyword: one exam or multiple lines how to choose your virginia
targetKeywords: one exam or multiple lines how to choose your virginia
...
imageAlt: One Exam or Multiple Lines? How to Choose Your Virginia Licensing Path
---
...
Taking both Series 11-01 and Series 11-03 gives you authority to sell life, annuities, health, property, and casualty insurance — every major line. This is the broadest possible Virginia producer license. In Virginia's licensing structure that is three qualifications, not five: Series 11-01 grants Life & Annuities and Health, and Series 11-03 grants Property and Casualty as a single combined qualification.
...
A failed Series 11-01 attempt does not lock you into the combined format. Virginia's rule is simply that a failed or expired exam registration requires you to re-register and pay another exam registration fee — at that point you register for whichever exam series you choose. So you can re-register for the combined Series 11-01 again, or switch to the separate Series 11-05 (Life & Annuities) and Series 11-06 (Health) exams if you would rather tackle the content in smaller pieces. Keep in mind that splitting into two exams means two registration fees ($35 each) and two test days, so most candidates who want all three L/A/H lines simply re-register for the combined 11-01. The takeaway: pick the format that fits your study strengths — a failed combined exam does not force you back into the combined format.

Does taking more exams at the start make the licensing process significantly more expensive?

Not dramatically. The most significant cost multiplier in Virginia licensing is the per-qualification application fee ($15 each), not the exam fee ($35 per exam). Taking both Series 11-01 and Series 11-03 gives you three qualifications — Life & Annuities, Health, and Property and Casualty — so it costs $70 in exam fees and $45 in application fees, a total of $115 before fingerprinting and the NIPR processing fee. By comparison, taking a single exam (Series 11-05 for Life & Annuities only) costs $35 in exam fees and $15 in application fees — $50 before other costs. The roughly $65 difference in combined licensing cost is minimal relative to the market access gained. The CE cost is more significant: dual licensees complete 24 CE hours biennial vs. 16 for single-line holders, which means 8 additional hours of CE every two years as an ongoing cost.

Can I take the Series 11-01 and Series 11-03 exams on the same day?

Prometric's scheduling system allows you to schedule both exams on the same day as back-to-back appointments if appointments are available. Series 11-01 and Series 11-03 are each 150 minutes plus check-in time — a combined test day of roughly 6 hours including check-in, breaks between exams, and scoring. This is demanding and generally not recommended for candidates who have not tested extensively under pressure conditions. Most candidates who pursue dual licensing schedule the exams on separate days — one to two weeks apart — allowing time to shift focus between the two content areas and process results from the first exam before sitting the second.
