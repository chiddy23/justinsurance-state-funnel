...
export const STATE_LAW_MNEMONICS: Mnemonic[] = [
  { num: 11, title: "The State Without Mandatory Auto Insurance", phrase: '"Only NH Says No"', items: ["**New Hampshire:** The only state with no general mandatory auto liability insurance requirement (drivers must still satisfy financial-responsibility rules)", "**Virginia:** No longer an exception — the $500 uninsured motor vehicle fee was eliminated effective July 1, 2024, and every Virginia-registered vehicle must now carry liability insurance", "Remember it as ONE state, not a pair"] },
...
export const PRACTICE_QUESTIONS: PracticeQ[] = [
  ...
  { id: "q6", tag: "State-Specific — Texas", text: "Under Texas law, which of the following is TRUE regarding the training required to sell annuities?", options: [{ letter: "A", text: "Texas agents require no special training before selling annuities to any client" }, { letter: "B", text: "Texas agents must complete a one-time 4-hour annuity certification course before selling any annuity, to a client of any age", correct: true }, { letter: "C", text: "Variable annuities in Texas do not require a securities registration" }, { letter: "D", text: "Texas prohibits the sale of fixed indexed annuities to clients over age 70" }], answer: "B", explanation: "Texas requires a one-time 4-hour TDI-approved annuity (Annuity Best Interest) certification course before an agent may solicit, sell or negotiate ANY annuity product — it is not limited to clients age 65 or older. Resident agents must also complete 8 hours of annuity-specific CE in each subsequent two-year license period. Agents must still make a best-interest suitability determination before recommending a product." },
...
export const SEVEN_DAY_PLAN: DayPlan[] = [
  ...
  { day: 2, goal: "Complete your Universal Foundation", morning: "Read Part 2, Policy Provisions, Clauses & Riders and Social Insurance sections. Make a chart of the key provisions — incontestability, grace period, free look, waiver of premium — and map Medicare Parts A-D against Medicaid. (2 hours)", afternoon: "Read Part 2, Universal Principles section. Create flashcards for: subrogation, indemnity, insurable interest, contract principles, and unfair trade practices. (2 hours)", evening: "Review Part 3, Key Terms Glossary — work through all 50 terms. Mark any you don't know well — these become your Day 6 focus. (1 hour)" },
