---
title: "Virginia LTC Partnership Training: The 8-Hour Requirement Before Your First Sale"
description: Virginia's Long-Term Care Partnership program is a state-federal collaboration that allows policyholders to protect personal assets from Medicaid spend-...
keyword: virginia ltc partnership training the 8hour requirement
targetKeywords: virginia ltc partnership training the 8hour requirement
...
imageAlt: "Virginia LTC Partnership Training: The 8-Hour Requirement Before Your First Sale"
---
...
Available long-term care services and providers, and changes or improvements in those services and providers
...
The training must be approved for [continuing education](/virginia/continuing-education) credit by the Virginia Insurance Continuing Education Board. Not all LTC courses satisfy this requirement — the course must be specifically approved as Partnership training covering the content above, so confirm current Board approval before you enroll.
...
Critical compliance rule: the ongoing requirement runs on a strict 24-month cycle. If you let it lapse, you are out of compliance and cannot sell LTC Partnership policies until you complete current, Board-approved training — so treat the 24-month ongoing-training deadline with the same seriousness as any hard filing date. If your last training has already expired, confirm with your CE provider or the Board exactly what "getting current" requires before you sell again.
...
Non-resident producers: Non-resident producers who sell LTC Partnership products in Virginia must meet the same standard — 8 hours of initial training and 4 hours of ongoing training every 24 months, satisfied through training the Virginia CE Board has approved. Before you rely on hours completed in another state, confirm two things with your provider: that the specific course is approved by the Virginia Insurance Continuing Education Board, and that your completed hours are on file.
...
Yes. The Virginia Insurance Continuing Education Board approves online LTC Partnership training courses. When selecting a course, confirm that: it is approved by the Virginia Insurance CE Board; it is specifically identified as an LTC Partnership training course (not just a general LTC product-knowledge course); it covers the subjects 14VAC5-200-205(E) requires; and it runs at least 8 hours for the initial requirement. Whether the course is delivered as a single integrated 8-hour program or assembled from separate modules does not matter — what matters is that the total approved hours meet the floor.

Does the 4-hour ongoing training have to be a Partnership course, or will any LTC continuing education do?

It has to be LTC training the Virginia Insurance CE Board has approved as satisfying the Partnership ongoing-training requirement — not just any general LTC continuing-education hours. 14VAC5-200-205(E) requires no less than four hours every 24 months covering the same body of Partnership content as the initial course. A generic LTC product course that is not approved as Partnership training will not keep your Partnership selling authority current. When selecting your ongoing course, confirm the same criteria as for the initial course: approved by the Virginia Insurance CE Board, identified as LTC Partnership training, and covering the required subjects.

If I completed LTC training in another state, do I still need to train again in Virginia?

It depends on whether that course is approved in Virginia. The requirement is 8 hours of initial Partnership training (and 4 hours of ongoing training every 24 months) approved by the Virginia Insurance CE Board. There is no automatic credit that carries hours across state lines, and no separate Virginia-only module the regulation forces you to bolt on. If the 8-hour course you completed elsewhere is also Virginia CE Board-approved as Partnership training, it can satisfy the requirement; if it is not, you complete Virginia-approved training. Ask your CE provider to confirm the specific course's Virginia approval before you rely on it.
