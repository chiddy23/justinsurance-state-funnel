---
title: 'Before You Write a Policy: Kentucky Workers'' Comp & Fraud Laws Explained'
description: >-
  Kentucky Workers' Comp & Insurance Fraud: Agent Guide 2025. Practical guide to
  Kentucky workers compensation insurance for Kentucky agents. Get the...
keyword: Kentucky workers compensation insurance
targetKeywords: Kentucky workers compensation insurance
...
This threshold is notably stricter than Missouri, which requires coverage for 5 or more employees in general industries (1 or more in construction). Indiana matches Kentucky's 1-employee standard.

## What Non-Compliance Actually Costs in Kentucky

Get this one right, because it gets misstated constantly — including by people selling coverage. Failing to carry required workers' compensation in Kentucky is not a felony. There is no felony classification for it anywhere in KRS Chapter 342, and no stop-work-order authority in the penalty statute either.

What KRS 342.990(7)(c) actually provides is a civil penalty of $100 to $1,000 for each offense for violating KRS 342.340, the coverage requirement. The teeth are in how "offense" is defined: each employee and each day of violation is a separate offense. An uninsured employer with four employees who goes ninety days without coverage isn't looking at one penalty — it's 360 separate offenses. That math is what makes the exposure serious, not a felony label.

The bigger risk is on the liability side, and it's the point worth making to a hesitant client. Under KRS 342.690(2), an employer that fails to secure payment of compensation loses the exclusive remedy protection that workers' comp otherwise buys. An injured employee can claim compensation and also file a civil action at law for damages — and in that lawsuit the employer cannot plead that the injury was caused by a fellow servant's negligence, that the employee assumed the risk of employment, or that the employee was contributorily negligent. The employer walks into court stripped of its standard defenses and personally on the hook for benefits an insurer would otherwise have paid.

So the honest pitch to a business owner questioning whether they really need coverage for their one part-time employee isn't "you'll be a felon." It's: per-employee, per-day civil penalties that compound, plus an uninsurable civil lawsuit you're defending with no defenses. Don't overstate the criminal side — a client who later learns the felony claim was wrong has reason to doubt everything else you told them.
...
Penalties under KRS 304.47-020 are tiered by the dollar value involved: below $500 the offense is a misdemeanor, while $500 or more is a Class D felony, $10,000 or more a Class C felony, and $1,000,000 or more a Class B felony. Fines run up to $10,000 for an individual felony conviction and up to $100,000 — or twice the gain, whichever is greater — for a corporation, on top of imprisonment and restitution. Producers who knowingly participate in fraudulent transactions — whether by submitting false applications, misrepresenting coverage terms, or facilitating premium fraud schemes — face license revocation on top of criminal liability. The consequences are career-ending, not just financially damaging.
...
- What is the penalty for operating without workers' comp coverage in Kentucky? It is a civil penalty, not a felony. KRS 342.990(7)(c) sets a fine of $100 to $1,000 for each offense for violating the KRS 342.340 coverage requirement, and each employee and each day of violation counts as a separate offense — so the total compounds quickly. Separately, under KRS 342.690(2) an uninsured employer loses exclusive remedy protection: the injured worker can pursue workers' comp benefits and also sue the employer at law, and the employer cannot raise the fellow-servant, assumption-of-risk, or contributory-negligence defenses.
...
- How do I report suspected insurance fraud in Kentucky? Report suspected fraud to the KDOI's Fraud Division through insurance.ky.gov or by calling the KDOI directly at (502) 564-3630. Also follow your appointing insurer's internal SIU reporting procedures. Reports can often be made anonymously. Producers who knowingly fail to report suspected fraud when aware of it risk their own regulatory standing.
Fraud prevention and producer conduct under KRS Chapter 304 are central to protecting your license. JustInsurance's Kentucky-approved [property & casualty continuing education](/kentucky/continuing-education) keeps commercial-lines producers current on Kentucky's conduct standards so you walk into every client meeting fully prepared. Enroll at justinsuranceco.com.
