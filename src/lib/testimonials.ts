...
const YOUTUBE_COMMENTS: Testimonial[] = [
  ...
  },
  {
    ...
    source: "youtube",
    state: "Texas",
    text: "This video contributed to me passing my Life + Health Exam in Texas. I also read the Kaplan insurance book and the Texas book.",
    videoId: "CFofL1mdURM",
  },
  {
    name: "Ghostwarior",
  ...
  },
  {
    ...
    source: "youtube",
    state: "Texas",
    text: "Taking my test tomorrow in San Antonio Texas hopefully I pass this is my 2nd time watching your video",
    videoId: "CFofL1mdURM",
  },
  {
    name: "Ronmalloy",
    ...
    text: "Passed using ChatGPT SC Life Accident and Health. And studying your YouTube videos.!",
    videoId: "Dwnu9SgMl4Y",
  },
  {
    name: "Mausupatel",
  ...
  },
  {
    ...
    source: "youtube",
    state: "Kentucky",
    text: "Just passed the KY life and health on my first try. I was so anxious! Thank you a gazillion for these videos. I have watched these as well as a few others and the Xcel course. THANK YOU!",
    videoId: "OOmBWg8yKxo",
  },
  {
    name: "Chillcharlie",
  ...
  },
  {
    ...
    source: "youtube",
    state: "Pennsylvania",
    text: "Just passed my PA on the 28th!",
    videoId: "Z776jev3XLg",
  },
  {
  ...
  },
  {
    ...
    source: "youtube",
    state: "Massachusetts",
    text: "I’ve been milking ChatGPT as much as I can but I still can’t pass I’m going for my 5th try tomorrow Massachusetts accidental life and health Prometric exam sucks so bad",
    videoId: "Dwnu9SgMl4Y",
  },
  {
    name: "Student, Kentucky",
    ...
    source: "youtube",
    state: "Kentucky",
    text: "I’ve been watching all your videos and I’m from KY. Been tested for three times and still haven’t pass yet. Is there anything you can recommend what/how I should be studying?",
    videoId: "f_aMeQ2dgBo",
  },
  {
    name: "Connorgage",
    ...
    source: "youtube",
    state: "Michigan",
    text: "Thank you for this. Passed Michigan Life Accident and Health last week and taking Michigan Variable Life and Annuities Producer exam in 3 days. Is there any content of yours that you recommend for that? I'd love to check it out. Preciate it, Justin!",
    videoId: "hADoF38rhdk",
  },
  {
    name: "Student, Indiana",
    initials: "IN",
    source: "youtube",
    state: "Indiana",
    text: "I've been trying to pass this test for about a yr, Really REALLY need to pass for Primerica here in indiana! I am a part of a great team but feel so far behind due to not passing yet. However thanks for your videos!",
    videoId: "hADoF38rhdk",
  },
  {
    name: "Nmb",
    ...
    source: "youtube",
    state: "Florida",
    text: "Passed the FL 240 and now studying to add the 214. So annoying in test that they ask you several questions about regulation departments OIR, CFO, DFS, FLAHIGA, and NAIFA. Take the time to review.",
    videoId: "hP7QMSMUxDI",
  },
  {
    name: "Amylilly",
    ...
    source: "youtube",
    state: "Florida",
    text: "I’m in Florida and need all the help I can get for my Life and Health. Vocab, tricks to learn and remember would be appreciated! thank you",
    videoId: "hP7QMSMUxDI",
  },
  {
    name: "Chadtravnick",
    ...
    source: "youtube",
    state: "Florida",
    text: "Question is this for which state? I am studying for the state of Minnesota, and it's considered one of the hardest in the USA to get your state life insurance license. I'm trying to pass the Minnesota Pre-License exam to get to the next stage. It was not as easy as my brother-in-law, who passed the second time in the state of Florida. Please help me if you have videos of the state of Minnesota Pre-license exam and Proctor Exam.",
    videoId: "it9dlxYAAbY",
  },
  {
    name: "Real S.",
    ...
    source: "youtube",
    state: "California",
    text: "Got a question, is this for the state of California? Thanks",
    videoId: "it9dlxYAAbY",
  },
  {
    name: "Oldham",
  ...
  },
  {
    ...
    source: "youtube",
    state: "Oregon",
    text: "I have taken my Oregon life only test already the first time and did not pass. Going to take it again this Friday thanks for the content, this was easy to follow along with.",
    videoId: "sUSUVgNzm1I",
  },
  {
    name: "Nathan",
    ...
    source: "youtube",
    state: "Illinois",
    text: "Justin my man I just want to say thank you! I just took my Illinois life exams this morning after watching multiple of your videos. Passed on the first try, the way you explain and make the terms relatable is unmatched! Keep it up for real!",
    videoId: "sUSUVgNzm1I",
  },
  {
    name: "Mistyb",
    ...
    source: "youtube",
    state: "Texas",
    text: "I passed my Texas Life and Health exam yesterday without taking a course and your videos were a big part of my studying, thank you for doing these!",
    videoId: "tVoyYZhVsng",
  },
  {
    name: "Theresaszufel",
    ...
    source: "youtube",
    state: "Florida",
    text: "Thank you for all the videos and information, I also have one of your test prep courses, the exams helped me alot... Passed my health and life for Florida this past Friday. A lot of situational questions on that exam. Thank you again.",
    videoId: "0hP0lwdeDAE",
  },
  {
    name: "Lizethgallegos",
    ...
    source: "youtube",
    state: "New Mexico",
    text: "I need help passing my NM life insurance producer .Have failed it twice any tip?",
    videoId: "0hP0lwdeDAE",
  },
  {
    name: "Mrstipton",
    ...
    source: "youtube",
    state: "Florida",
    text: "@princenate587 so did you take a certain course first when u failed and THEN watch all of his videos? Or do u think failing the first one helped because you got to actually see what was on the test and what to be more prepared for? I have waited so long to take this test I passed my course like 6 months ago never feeling like I retained enough from EXAMFX so now im just saying screw it I gotta try and watching a crap ton of videos before my test next week. Any advice.: also I’m in Florida.",
    videoId: "1MZWRHnmWFg",
  },
  {
    name: "Chanizzmatizz",
    ...
    source: "youtube",
    state: "Florida",
    text: "I DID! With flying colors ! I got and 86% on my first try! I put my back into the course, but I’ve steady been listening to your content for MONTHS and it def helped me ace that Florida 2-15 state exam on the first try! I wish I could upload a pic of it for receipts",
    videoId: "7OS6AMv42kg",
  },
  {
    name: "Defran",
    ...
    source: "youtube",
    state: "New York",
    text: "Just signed up to get my license in New York! Are your study guides specific to each state? Definitely plan on getting to help me pass!",
    videoId: "aqEVPMVJz7Q",
  },
  {
    name: "Dawsonkidwell",
    ...
    source: "youtube",
    state: "Utah",
    text: "Man I have took the Utah life insurance exam 100 times and I can’t pass it at all",
    videoId: "aqEVPMVJz7Q",
  },
  {
    name: "Student, Florida",
    ...
    source: "youtube",
    state: "Florida",
    text: "If I pass my test next month I’m flying to Florida to give you a hug lol",
    videoId: "BHoI_O47eE8",
  },
  {
    name: "Liudmila",
    ...
    source: "youtube",
    state: "New York",
    text: "Very confused with score. Had an exam on 21st. Didn’t pass, but the score was 84. NY Live accident and Health…",
    videoId: "BHoI_O47eE8",
  },
  {
    name: "Oscarmferia",
    ...
    source: "youtube",
    state: "California",
    text: "Will this video help ne pass the life and health insurance exam in California as well? Or do regulations differ by the state?",
    videoId: "CFofL1mdURM",
  },
  {
    name: "Iamsnowdoll",
    ...
    source: "youtube",
    state: "Louisiana",
    text: "I passed my exam today in Louisiana, with help from your videos",
    videoId: "dl3L1bb6hMA",
  },
  {
    name: "Emmaeduru",
    ...
    source: "youtube",
    state: "California",
    text: "Thank you so much. I just came back to give my appreciation. I only stumbled into your tutorial last week. After a four week study with examfx. Learning from your channel and two other channels helped me passed my exam yesterday in California.",
    videoId: "dPSl3nJrXIs",
  },
  {
    name: "Sheliabrumlow",
    ...
    source: "youtube",
    state: "Florida",
    text: "Thank you for the encouragement. I'm in Florida and I don't understand how people got the actual score, I was told it was pass -fail and you won't get your score.",
    videoId: "DVA1jPJXyJg",
  },
  {
    name: "Student, Arizona",
    initials: "AZ",
    source: "youtube",
    state: "Arizona",
    text: "Hey Justin, I just wanted to say thank you for these Videos. They were amazing. I passed my Arizona Life and Health Exam my first try. I just got my License number. I would watch these videos all day. The course didn't really help me understand what it was. Anyways just want to give credit were credit is due. Thank you again for these awesome videos.",
    videoId: "Hk6GfSD_9To",
  },
  {
    name: "Teachmemore",
    ...
    source: "youtube",
    state: "Utah",
    text: "Im in Utah I want to pass the exam",
    videoId: "hP7QMSMUxDI",
  },
  {
    name: "Student, Iowa",
    ...
    source: "youtube",
    state: "Iowa",
    text: "Thanks for your video is very informative . But I need your help about this chapter please : Iowa laws , rules and regulations common to all Line ( questions and answers)",
    videoId: "it9dlxYAAbY",
  },
  {
    name: "Buffyabuffy",
  ...
  },
  {
    ...
    source: "youtube",
    state: "Florida",
    text: "Your videos helped me passed the 0215 exam for Florida. Thank you so much.",
    videoId: "JzY4kCRPJzc",
  },
  {
    name: "Student, Washington",
    initials: "WA",
    source: "youtube",
    state: "Washington",
  ...
  },
  {
    ...
    source: "youtube",
    state: "Michigan",
    text: "Hey Justin @InsuranceExam just wanted to drop in the comments. Thank you very much sir! Watching your videos helped me pass the life insurance producer exam here in Michigan. Thank you for putting out videos that are easy to digest and understand",
    videoId: "qoKyq9XrbuY",
  },
  {
    name: "Marlenerautier",
    ...
    source: "youtube",
    state: "Florida",
    text: "Hi, I’m preparing for the Florida life insurance exam, you mentioned that you have a better real practice similar to the actual exam for $37 I’d love to purchase that please send me the information on how to get it thanks",
    videoId: "qoKyq9XrbuY",
  },
  {
    name: "Teachmemore",
    ...
    source: "youtube",
    state: "Utah",
    text: "I need pass Life and Health exam in Utah",
    videoId: "qoKyq9XrbuY",
  },
  {
    name: "Student, Tennessee",
    initials: "TN",
    source: "youtube",
    state: "Tennessee",
    text: "Good morning, do you have a practice exam for state of Tennessee? Can I get that please, sir! Thank you, for the information !",
    videoId: "vK9JlVgR-4g",
  },
  {
    name: "Fredanderson",
    ...
    source: "youtube",
    state: "Michigan",
    text: "Can u please send practice exam for Michigan, thanks thanks,",
    videoId: "vK9JlVgR-4g",
  },
  {
    name: "Jaderiusreed",
    ...
    source: "youtube",
    state: "Texas",
    text: "I was taking my exam on a Wednesday and I started studying on a Sunday . This video mixed with some sheets I printed off and notes I wrote down helped me pass my Texas Exam . Thanks for the help",
    videoId: "Xjyrb47oGr8",
  },
  {
    name: "Notchose",
    ...
    source: "youtube",
    state: "Texas",
    text: "I’m in Texas, taking the exam on 26th… hope I pass I am taking g notes and listening til then! Purchased a course but it’s horrible I need human interaction! This is the next best thing!",
    videoId: "Xjyrb47oGr8",
  },
  {
    name: "Student, Georgia",
    initials: "GA",
    source: "youtube",
    state: "Georgia",
    text: "Passed my state exam just an hour ago! (Georgia) thank you for your videos.",
    videoId: "zcCOK4ztwec",
  },
  {
    name: "Mauricecooper",
    ...
    source: "youtube",
    state: "Missouri",
    text: "I'm studying for my third attempt at the Missouri State exam... I hope to pass it in 9 days!",
    videoId: "zcCOK4ztwec",
  },
  {
    name: "Michi",
    ...
    source: "youtube",
    state: "Florida",
    text: "@InsuranceExam I passed, 1st try with 89 in FL. Thank you again, I know listening to you lulling me to sleep help me a ton!",
    videoId: "0hP0lwdeDAE",
  },
  {
    name: "Mausupatel",
    ...
    source: "youtube",
    state: "California",
    text: "I gave a life exam last week but I didn’t pass California can you help me .",
    videoId: "1MZWRHnmWFg",
  },
  {
    name: "Allycatttt",
    ...
    source: "youtube",
    state: "Florida",
    text: "is this a test for florida? thanks in advance",
    videoId: "1MZWRHnmWFg",
  },
  {
    name: "Lionofjudah",
    ...
    source: "youtube",
    state: "Texas",
    text: "I also wanted to add that I do have my TX Life insurance license and now I am with a new company, so I am needing the Health ins lic- this would consider me having my \"General Lines\" as required. This also means that I would be re-taking the Life portion? Thank you again!",
    videoId: "8dY_KNwpg4k",
  },
  {
    name: "Cali P.",
    ...
    source: "youtube",
    state: "Idaho",
    text: "Can you send me the link for your Idaho Health only cram course? Thanks",
    videoId: "8dY_KNwpg4k",
  },
  {
    name: "Ikejones",
    ...
    source: "youtube",
    state: "Texas",
    text: "I live in the great state of Texas. Which of your videos do I need to focus on to pass the life and health exam, and I know you provide the material needed to work with you selling insurance but do you have paid training and would you hire someone with a 16 year old Class C felony (possession of controlled substance)?",
    videoId: "8dY_KNwpg4k",
  },
  {
    name: "Blazec",
    ...
    source: "youtube",
    state: "Florida",
    text: "I love that you helping us pass the Florida exam thank you. Can you do a video/live covering everything that will be on the exam please? I know atleast 50 people that will watch it",
    videoId: "BHoI_O47eE8",
  },
  {
    name: "Starchix",
    ...
    source: "youtube",
    state: "California",
    text: "The passing score is 60% for California. I would like to get higher.",
    videoId: "bP1q3rK6bI0",
  },
  {
    name: "Petricã",
    ...
    source: "youtube",
    state: "Maine",
    text: "2nd Fail FUK IT I give up I surrender NOT FOR ME! There's entirely too much word trickery to be of an ethical testing nature...I can sell catch up popsicles to people in white gloves I'll just work Clinical Client Placement (Drug & Alcohol Rehabilitation)at least there's a decent base & bonus No wonder 90% of people that pass don't do this for long because they're not sales people!",
    videoId: "DVA1jPJXyJg",
  },
  {
    name: "Danielapinto",
  ...
  },
  {
    ...
    initials: "JA",
    source: "youtube",
    text: "MY MAN! You put it so brain dead that anyone can understand! You have no clue the weight you just lifted off my shoulders! Thank you!",
    videoId: "OzD0syM2d70",
  },
  {
    name: "Redcronojm",
    initials: "RE",
    source: "youtube",
    text: "I finally pass my life exam thanks to you",
    videoId: "tKtwDDSPstE",
  },
  {
    name: "Jessicagreen",
    initials: "JE",
    source: "youtube",
    text: "I haven’t passed yet. I’m going on my 6th time. I am frustrated with the test as you are explaining the information it’s not on the test.",
    videoId: "8dY_KNwpg4k",
  },
  {
    name: "Mrrj",
    initials: "MR",
    source: "youtube",
    text: "I'm retaking my test on Sunday. This is awesome... Thank you so very much.",
    videoId: "it9dlxYAAbY",
  },
  {
    name: "JustInsurance Student",
    initials: "JI",
    source: "youtube",
    text: "I love how you explained this thing like you are talking to a 5 year old. So easy to understand",
    videoId: "dPSl3nJrXIs",
  },
  {
    name: "Builtfordtuff",
    initials: "BU",
    source: "youtube",
    text: "Hey brotha, when i pass the test you will have another testimony video in the bag Awesome stuff man thanks so much",
    videoId: "it9dlxYAAbY",
  },
  {
    name: "JustInsurance Student",
    initials: "JI",
    source: "youtube",
    text: "Currently having to take an online insurance class to receive my license, this is a huge help. Thank you!",
    videoId: "Xjyrb47oGr8",
  },
  {
    name: "Peyton A.",
    initials: "PA",
    source: "youtube",
    text: "Hey bro just wanna say I failed my exam 4 times for life and health and after i started watching your videos I passed today just wanna say these videos frl helped me u should do health polices aswell cause the these videos made me ace the life section",
    videoId: "bP1q3rK6bI0",
  },
  {
    name: "JustInsurance Student",
    initials: "JI",
    source: "youtube",
    text: "I just passed my exam today, I can say this webinar did help me a lot. Although I was a bit skeptical at first, the more the lesson went on the more I understood the topics. Thank you so much for this.",
    videoId: "CFofL1mdURM",
  },
  {
    name: "Devinrogers",
    initials: "DE",
    source: "youtube",
    text: "Definitely helped me! I did pre licensing class then chat gpt with the outline after watching some of your YouTube videos. I saw you use it in one so I tried it… worked wonderfully! I passed with confidence!",
    videoId: "Dwnu9SgMl4Y",
  },
  {
    name: "Davidallen",
    initials: "DA",
    source: "youtube",
    text: "thanks for making these videos! I just took my test the other day and failed so now studying for my second test",
    videoId: "hADoF38rhdk",
  },
  {
    name: "Abrahanrosa",
  ...
  },
  {
    ...
    initials: "VE",
    source: "youtube",
    text: "Am going tomorrow morning for nys accident life and health exam I got 26 correct. Update i passed",
    videoId: "HhtvSFxHomw",
  },
  {
    name: "Samirkosov",
    initials: "SA",
    source: "youtube",
    text: "Thank you passed it on the first try, its actually not that hard guys especially part 2, believe in yourself!",
    videoId: "-Iqfheopp8k",
  },
  {
    name: "Lightning",
    initials: "LI",
    source: "youtube",
    text: "thanks for all your helpful videos. been studying for a while, but i didn't know you had study group. gonna join",
    videoId: "1MZWRHnmWFg",
  },
  {
    name: "Arammaldonado",
    initials: "AR",
    source: "youtube",
    text: "Thanks for helping me pass my life insurance exam!",
    videoId: "7lREsWXDNFY",
  },
  {
    name: "Stevenfloyt",
    initials: "ST",
    source: "youtube",
    text: "Im going to binge watch all of your videos because i need to take my exam which i failed twice already, i struggle most with Hmos, Retirement, and Tax Topics, hopefully i can pass it soon!",
    videoId: "Hk6GfSD_9To",
  },
  {
    name: "Oboncharlen",
    initials: "OB",
    source: "youtube",
    text: "thank you for your vidoes . I passed my exam",
    videoId: "tVoyYZhVsng",
  },
