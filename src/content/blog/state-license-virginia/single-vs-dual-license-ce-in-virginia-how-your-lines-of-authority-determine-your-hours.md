---
title: "Single vs. Dual License CE in Virginia: How Your Lines of Authority Determine Your Hours"
description: The single most important thing to understand about Virginia's continuing education system is that your CE obligation is determined not by how many line...
keyword: single vs dual license ce in virginia how your lines of
targetKeywords: single vs dual license ce in virginia how your lines of
...
Virginia's CE rules, codified at Va. Code § 38.2-1866, run off the license categories the Bureau actually issues — life and annuities agent, health agent, property and casualty agent, personal lines agent, title agent, and insurance consultant. For the producer lines most new agents hold, those sort into two practical groups:

License Type 1: Life, Annuities, and Health This category includes:

Life and Annuities — Prometric exam Series 11-05

Health — Prometric exam Series 11-06

Both at once, via the combined Life, Annuities & Health exam (Series 11-01), which qualifies you for the Life and Annuities license and the Health license in one sitting

Variable Life and Variable Annuity Products authority, which is exempt from the exam but rides on an active Life and Annuities license plus FINRA securities registration

Virginia issues Life and Annuities and Health as two separate agent licenses, but Va. Code § 38.2-1866(C) collapses them for CE: an agent who holds "a life and annuities license or a health agent license, or both" completes 16 hours. Two licenses, one 16-hour obligation.
...
Title insurance is its own license type in Virginia, with its own exam (Series 11-04), its own prelicensing requirement under Va. Code § 38.2-1814.1, and its own 16-hour CE obligation under § 38.2-1866(E). A title agent who also holds a Life and Annuities license holds two license types and lands in the 24-hour bracket the same way an L/A/H + P&C producer does. Title sits outside most JustInsurance students' plans, but it is worth knowing that "two license types" is not limited to L/A/H plus P&C.

## How the Hours Work

The jump from 16 to 24 hours happens only when you cross from one license type to two. Within a single license type, adding qualifications does not increase your CE obligation.
...
Virginia does allow excess CE credit hours to carry forward, but the rule is narrow. Under Va. Code § 38.2-1867(D), an agent with excess credit hours accumulated during a renewal cycle may carry those hours forward to the next renewal cycle only — there is no multi-cycle banking. The CE Board adds two conditions worth knowing before you rely on it:

Excess credits will not be carried over if you fail to renew your license during the 90-day renewal period

Carry forward does not apply to public adjusters, whose excess credits are never carried over to the next renewal period

Practically, this means over-completing is a modest hedge rather than a strategy. A dual licensee who finishes 28 hours in a cycle and renews on time starts the next biennium with a 4-hour cushion; a producer who misses the renewal window loses the surplus entirely along with the license status. Verify what actually posted on your Sircon transcript rather than assuming a carried-forward balance is there.
...
The more operationally important point is that under-completing dual licensee CE is a common mistake. Producers who hold both L/A/H and P&C licenses and complete only 16 hours have not satisfied their requirement. Licenses that fail to meet CE requirements are administratively terminated on the renewal date with no grace period. Virginia does send renewal reminders — the CE Board mails a courtesy notice roughly six months before your compliance date, and the Bureau of Insurance follows with a renewal notice 90 days out and a reminder notice 30 days out — but these are keyed to your renewal date rather than being deficiency alerts that flag a specific shortfall, and they can go astray if the address on file is stale. Monitoring your own CE transcript on Sircon remains your responsibility.
...
If you voluntarily drop a line of authority mid-biennium — for example, removing your P&C lines to hold only L/A/H — your CE obligation for the next renewal cycle reverts to 16 hours. The immediate effect is on how credits already completed in the current biennium are categorized: credits applicable to the dropped license type may still count toward your general CE total for the current period, or may only apply to the remaining license type, depending on their course category. Any hours left over above your requirement are not automatically wasted — Va. Code § 38.2-1867(D) lets an agent carry excess credit hours forward to the next renewal cycle only, and only if you renew within the 90-day renewal period. Check your transcript on Sircon after any license change to confirm the current credit balance and applicable categories, or contact the Bureau of Insurance if you have questions about how mid-biennium license changes affect course credit applicability.

Is Personal Lines treated as a separate license type from full Property and Casualty for CE purposes?

No — and in practice you will only ever hold one of them. Va. Code § 38.2-1866(D) puts both in the same 16-hour bracket: an agent who holds a personal lines license or a property and casualty license completes 16 hours. The Bureau's licensing bulletin also instructs applicants not to apply for both, because the Property and Casualty license already carries personal lines authority. So a Personal Lines–only producer completes 16 hours and a full Property and Casualty producer completes 16 hours. Either one who adds a Life and Annuities or Health license then holds two license types and moves to 24 CE hours, with the 8-hour minimum applying to each type. Which P&C credential you hold does not change that math.
