---
title: 'Kentucky Insurance Laws on the Exam: What Agents Must Know About KRS Chapter 304'
description: >-
  Kentucky Insurance Laws for the Exam: KRS 304 Guide. Practical guide to
  Kentucky insurance laws exam for Kentucky agents. Get the rules, timelines,
  and...
keyword: Kentucky insurance laws exam
targetKeywords: Kentucky insurance laws exam
...
imageAlt: >-
  ...
  insurance laws on the exam: what agents must know a.
---
...
The exam also tests basic workers' compensation knowledge under KRS Chapter 342. Kentucky requires workers' compensation coverage for any employer with one or more employees — one of the lowest thresholds in the country. The coverage requirement itself is KRS 342.340, and the penalty for violating it is a civil one: KRS 342.990(7)(c) sets a fine of $100 to $1,000 for each offense. The teeth are in the definition of "offense" — each employee and each day of violation counts separately, so an uninsured employer's exposure compounds fast. There is no felony classification anywhere in KRS 342.990, so treat any study material that calls this a "Class D felony" as wrong. The Department of Workers' Claims (DWC) administers the program, NCCI is the rating bureau, and Kentucky Employers Mutual Insurance (KEMI) is the state's primary insurer for the market.
...
- Is Kentucky's workers' compensation coverage requirement tested on the Property & Casualty exam? Yes. Know the 1-employee coverage threshold, the penalty for non-compliance (a civil fine of $100 to $1,000 per offense under KRS 342.990(7)(c) for violating the KRS 342.340 coverage requirement, with each employee and each day of violation counting as a separate offense — not a felony), that NCCI is the rating bureau, and that the DWC (not the KDOI) administers claims.
JustInsurance's Kentucky [Life & Health prelicensing](/kentucky/prelicensing) course covers the KRS Chapter 304 insurance-law content tested on the Life and Health licensing exam — producer licensing, unfair trade practices, and the Annuity Best Interest standard among them. Prepare thoroughly and pass with confidence. Enroll at justinsuranceco.com.
