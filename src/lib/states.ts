...
export const STATES: Record<string, StateData> = {
  ...
  alaska: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact Alaska DOI",
  ...
  hawaii: {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "Penalty fee applies if CE completed within 15 days of or after due date",
        gracePeriod: "No formal grace period; inactivation risk at expiration",
        reinstatementFee: "Penalty fee per Commissioner's Memo 2021-9LIC — contact DOI",
        reinstatementWindow: "Reinstatement term revised effective Jan 1, 2022",
        carryForward: "No — CE carry-forward not permitted",
        lapseConsequence: "Your license is inactivated, you cannot transact insurance, and a penalty fee plus CE completion is required to reinstate.",
      },
    },
  ...
  kentucky: {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "Not publicly posted — contact Kentucky DOI",
        gracePeriod: "Up to 1 year from termination to complete delinquent CE",
        reinstatementFee: "Standard license fees — specific amount not publicly posted",
        reinstatementWindow: "12 months from termination without prelicensing/exam",
        carryForward: "No — CE carry-forward not permitted (24 hrs biennial, 3 ethics)",
        lapseConsequence: "Your license terminates and you have 12 months to complete delinquent CE and pay fees before prelicensing and exam are required.",
      },
    },
  ...
  louisiana: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Yes — up to 10 excess hours (life/health/P&C); none for adjusters",
  ...
  maine: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact Maine DOI",
  ...
  maryland: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact Maryland DOI",
  ...
  massachusetts: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact Massachusetts DOI",
  ...
  minnesota: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact MN Commerce",
  ...
  mississippi: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact Mississippi MID",
  ...
  montana: {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact Montana CSI",
  ...
  "new-mexico": {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "$50 CE penalty before renewal is processed",
        gracePeriod: "None — license becomes inactive at expiration",
        reinstatementFee: "Not publicly posted — contact New Mexico OSI",
        reinstatementWindow: "Reinstatement handled through NIPR same as new application",
        carryForward: "Not publicly posted — contact New Mexico OSI",
        lapseConsequence: "Your license becomes inactive and you must reapply through NIPR before legally transacting insurance again.",
      },
    },
  ...
  "rhode-island": {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "$100 late fee added to reinstatement",
        gracePeriod: "None — late fee applies after expiration",
        reinstatementFee: "$100 late fee plus $120 resident renewal fee",
        reinstatementWindow: "Reinstatement window not publicly posted — contact RI DBR",
        carryForward: "Not publicly posted — contact Rhode Island DBR",
        lapseConsequence: "Your license expires and you must pay a $100 late fee plus the renewal fee and complete all CE to reinstate.",
      },
    },
  ...
  vermont: {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "Not publicly posted — contact Vermont DFR",
        gracePeriod: "None — license cannot be reactivated once lapsed",
        reinstatementFee: "None — must apply as new license",
        reinstatementWindow: "No reinstatement; must apply as new license",
        carryForward: "No — excess CE credits do not carry over between review periods",
        lapseConsequence: "Your license cannot be reactivated and you must apply for a new license, including any required testing.",
      },
    },
  ...
  washington: {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "Additional late fee applies (amount on OIC fee schedule)",
        gracePeriod: "60 days after expiration to renew with late fee",
        reinstatementFee: "Set on OIC fee schedule — contact Washington OIC",
        reinstatementWindow: "Up to 60 days renew with late fee; reinstatement application after",
        carryForward: "Not publicly posted — contact Washington OIC",
  ...
  "west-virginia": {
    ...
    ce: {
      ...
      compliance: {
        ...
        carryForward: "Not publicly posted — contact West Virginia OIC",
  ...
  wisconsin: {
    ...
    ce: {
      ...
      completionTime: "A few hours (depending on course length)",
      compliance: {
        lateFee: "Not publicly posted — contact Wisconsin OCI",
        gracePeriod: "12-month reinstatement window after revocation",
        reinstatementFee: "$140 reinstatement fee",
        reinstatementWindow: "12 months from expiration to reinstate",
        carryForward: "Not publicly posted — contact Wisconsin OCI",
        lapseConsequence: "Your license is revoked and you have 12 months to complete CE and pay a $140 fee before you must retake prelicensing and the exam.",
      },
    },
